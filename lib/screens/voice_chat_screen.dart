...
import 'package:rafiqi/utils/permissions_helper.dart';
...
class _VoiceChatScreen2State extends State<VoiceChatScreen2> {
  ...
  Future<void> _initializeVoiceChat() async {
    await PermissionsHelper.checkMicrophonePermission(
      onDenied: () {
        setState(() {
          _response = "Microphone permission denied. Please enable it in settings.";
        });
      },
    );
